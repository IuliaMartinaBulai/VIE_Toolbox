...
%
% This reproduces figure 1 from "Modeling metastatic tumor evolution, 
...
%% Load numerical results for lung, five different growth laws
clc
clear all
close all

fprintf('Welcome to VIE demo #4\n');
addpath(fullfile('','Data'));
fprintf('Loading the numerical results for lung \n');
load('mass_number_lung_t_60.mat');
